...
<div class="flex h-screen overflow-hidden">
        ...
        <aside class="w-64 bg-white border-r border-gray-200 hidden md:flex flex-col">
            <div class="p-6">
                <h1 class="text-2xl font-bold text-[#000000] tracking-tight">TaskFlow</h1>
            </div>
            
            <nav class="flex-1 px-4 space-y-2">
                <a href="#" class="flex items-center p-3 text-[#000000] bg-indigo-50 rounded-xl font-semibold">
                    Dashboard
                </a>
            ...
            <header class="bg-white border-b border-gray-200 sticky top-0 z-10">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-4">
                        <a href="{{ route('tasks.create') }}" class="bg-[#000000] hover:bg-[#000000] text-white px-4 py-2 rounded-lg text-sm font-medium shadow-md">
                            + Nova Tarefa
                        </a>
                    </div>
                </div>
                                ...
                                <tr class="hover:bg-gray-50 transition">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center">
                                            <input type="checkbox"
                                                class="h-4 w-4 text-[#000000] rounded border-gray-300 mr-3"
                                    ...
                                    <td class="px-6 py-4 text-right space-x-2">
                                        <a href="{{ route('tasks.edit', $task->id) }}" class="text-gray-400 hover:text-[#000000]">
                                            ✏️
                                        </a>
